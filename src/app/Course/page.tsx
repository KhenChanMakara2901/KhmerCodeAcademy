    ...
    <div className="max-w-screen-2xl mx-auto">
      <div className="bg-gradient-to-r  from-sky-700 to-fuchsia-400  animate-slide-Out h-ful p-5">
        <h2 className="font-extrabold text-white text-3xl text-center sm:text-4xl md:text-5xl lg:text-6xl animate-fadeIn">
          OUR COURSE YOU CAN CHOOSE FROM
        </h2>
      </div>
      <div className="max-w-screen-lg mx-auto">
        <div className="flex flex-col gap-4 md:flex-row items-center justify-center mt-20">
          <div className="md:w-1/3 p-6 rounded-lg border shadow shadow-blue-700 bg-gradient-to-r  from-orange-600 to-orange-200 animate-fadeIn">
          ...
          <div className="md:w-1/3 p-6 rounded-lg border shadow shadow-orange-600 bg-gradient-to-r from-blue-700 to-blue-200 animate-fadeIn">
          ...
          <div className="md:w-1/3 p-6 rounded-lg border shadow shadow-black bg-gradient-to-r from-yellow-500 to-yellow-200 animate-fadeIn">
        ...
        <div className="flex flex-col gap-4 md:flex-row items-center justify-center pt-10">
          <div className="md:w-1/3 p-6 rounded-lg border shadow shadow-yellow-500  bg-gradient-to-r from-blue-900 to-blue-200 animate-fadeIn">
          ...
          <div className="md:w-1/3 p-6 rounded-lg border shadow shadow-blue-950 bg-gradient-to-r from-sky-500 to-sky-200 animate-fadeIn">
          ...
          <div className="md:w-1/3 p-6 rounded-lg border shadow shadow-sky-600  bg-gradient-to-r from-black to-white animate-fadeIn">
